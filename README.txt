...
V1.0.19: Approved homepage, original logo/mosque/QR assets, copyright by KimhanIkals.

V1.0.19 - Address & UX Fix
--------------------------
...
V1.0.19: searchable postcode, admin detail, print/save PDF, pastel status cards.

V1.0.19 - Multi Page + Admin Phase 1
...
V1.0.19: member detail layout, print fixes, news fixed scroll, register steps moved, payment/donation pages, member sort/pagination, Settings text format.

V1.0.19 - Cute Homepage & News Fix
---------------------------------
...
V1.0.19 - Cute Assets + Donation Form
--------------------------------------
...
V1.0.19 - Embedded Cute + Smart Donation
-----------------------------------------
...
V1.0.19: Homepage rebuilt to match approved reference, real association logo retained; reference assets placed in assets/img root; admin finance summary added.

V1.0.19 - Asset Recovery + Admin Transactions
----------------------------------------------
...
V1.0.19: Web Content Manager, in-page News Center with activity images, Accounting ledger, date-range Reports, grouped Website Management menu.
...
V1.0.19 - News UX + Transaction Tables + Real Accounting + Media Library
-----------------------------------------------------------------------
...
V1.0.19 FIX1 - SetupSystem Repair
---------------------------------
...
V1.0.19: Restored quote, clean background, News Center hides homepage dashboard row, benefit usage with accounting expense, member portal/history.

V1.0.19 - Portal Fix + Admin Member 360 + Multi-Image Activities + Phase 2
-------------------------------------------------------------------------
...
V1.0.19 - Gallery Navigation + Active Tabs + Hero Cleanup + Member Dashboard
----------------------------------------------------------------------------
