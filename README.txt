...
V1.0.23: Approved homepage, original logo/mosque/QR assets, copyright by KimhanIkals.

V1.0.23 - Address & UX Fix
--------------------------
...
V1.0.23: searchable postcode, admin detail, print/save PDF, pastel status cards.

V1.0.23 - Multi Page + Admin Phase 1
...
V1.0.23: member detail layout, print fixes, news fixed scroll, register steps moved, payment/donation pages, member sort/pagination, Settings text format.

V1.0.23 - Cute Homepage & News Fix
---------------------------------
...
V1.0.23 - Cute Assets + Donation Form
--------------------------------------
...
V1.0.23 - Embedded Cute + Smart Donation
-----------------------------------------
...
V1.0.23: Homepage rebuilt to match approved reference, real association logo retained; reference assets placed in assets/img root; admin finance summary added.

V1.0.23 - Asset Recovery + Admin Transactions
----------------------------------------------
...
V1.0.23: Web Content Manager, in-page News Center with activity images, Accounting ledger, date-range Reports, grouped Website Management menu.
...
V1.0.23 - News UX + Transaction Tables + Real Accounting + Media Library
-----------------------------------------------------------------------
...
V1.0.23 FIX1 - SetupSystem Repair
---------------------------------
...
V1.0.23: Restored quote, clean background, News Center hides homepage dashboard row, benefit usage with accounting expense, member portal/history.

V1.0.23 - Portal Fix + Admin Member 360 + Multi-Image Activities + Phase 2
-------------------------------------------------------------------------
...
V1.0.23 - Gallery Navigation + Active Tabs + Hero Cleanup + Member Dashboard
----------------------------------------------------------------------------
...
V1.0.23 - Alumni Registration Flow + Payment QR + Admin UX Fixes
...
V1.0.23 – Member Portal Phase 3 + Status Workflow + Performance
...
V1.0.23 – Print Fidelity + Mobile Header + Verification Safety
...
V1.0.23 – Receipt Phase 1 + Portal Address + Dynamic Membership Fee QR
- Member Portal: editable structured address fields saved to Addresses.
- Admin Settings: changing MEMBERSHIP_FEE_YEARLY synchronizes PAY-TOPIC-001 and invalidates QR/config cache immediately.
- Payment QR uses the latest annual fee after refresh.
- Receipt Phase 1: Receipts sheet, automatic issue after payment approval, unique receipt numbers, list/search/detail/print/reprint, and void-with-reason.
- Issued receipts are never hard-deleted.
