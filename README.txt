...
V1.0.11: Approved homepage, original logo/mosque/QR assets, copyright by KimhanIkals.

V1.0.11 - Address & UX Fix
--------------------------
...
V1.0.11: searchable postcode, admin detail, print/save PDF, pastel status cards.

V1.0.11 - Multi Page + Admin Phase 1
...
V1.0.11: member detail layout, print fixes, news fixed scroll, register steps moved, payment/donation pages, member sort/pagination, Settings text format.

V1.0.11 - Cute Homepage & News Fix
---------------------------------
...
V1.0.11 - Cute Assets + Donation Form
--------------------------------------
...
V1.0.11 - Embedded Cute + Smart Donation
-----------------------------------------
